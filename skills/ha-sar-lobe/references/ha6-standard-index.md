# HA Standard 6 — Normative Index for SAR Work

Use this file to locate and interpret the official standard. It is a retrieval index, not a substitute for the source PDF. Before quoting a requirement, resolving a borderline interpretation, or scoring a chapter, open the cited source page and read its notes and footnotes.

## Source identity and applicability

- Title: มาตรฐานโรงพยาบาลและบริการสุขภาพ ฉบับที่ 6 (Hospital and Healthcare Standards, 6th Edition)
- Issuer: สถาบันรับรองคุณภาพสถานพยาบาล (องค์การมหาชน), HAI
...
## How to read and use the standard

1. Start with the chapter's **overall requirement**, which contains the subject, action, important quality issue, key process, and intended goal.
2. Use the numbered multiple requirements to understand practices and test system completeness. Do not score them as separate additive items.
3. Interpret the chapter through local context, risks, core values, and 3P/3C-DALI.
4. Read footnotes for definitions and examples before treating a term as exhaustive.
5. For self-assessment, inspect the real situation through tracers, patient experience, records, interviews, observations, data, and results—not policy alone.
6. Use internal survey as peer learning, not fault-finding. Use medical-record review to learn about quality of care and adverse events, not only record completeness.
...
- I-1.2 ค: sustainable healthcare and societal contribution
- I-4.2 ค: information security and personal-data protection
- I-5: expanded workforce support, capability, well-being, and engagement
- II-7.3: blood bank and transfusion service
- II-10: Digital Care, including digital access, interoperability, exclusion risk, telemedicine, and AI governance
- III-4.3 ฎ: critical care
- Broader emphasis on digital technology/AI, sustainability, workforce care, 3P Safety, spiritual health, Thai traditional medicine, health promotion/tobacco, home care, and global change.

## Part I — Organization Management Overview

The page column points to the first page of the overall requirement, not the chapter overview diagram.
...
| IV-3 | Workforce Results | Capacity/capability/retention, work environment and safety, welfare and health promotion, engagement/satisfaction, development, and leadership results. |
| IV-4 | Leadership and Governance Results | Strategy, communication/engagement, governance and accountability, compliance, ethical conduct/trust, community contribution, and sustainable healthcare results. |
| IV-5 | Key Work Process Effectiveness Results | Effectiveness, efficiency, productivity, cycle time, quality and safety systems, emergency preparedness, and supply-network results. |
| IV-6 | Financial Results | Financial performance, return/viability, and budget-use results. |

## Official HA Scoring anchors

The Scoring Guideline is in book pages 231-238 / PDF pages 241-248. It assesses 54 process chapters/subchapters in Parts I-III and 6 result domains in Part IV.

| Score | Process | Result |
|---:|---|---|
| 1 | Design and early stage of implementation | Measure |
| 2 | Partial implementation, covering safety-essential criteria and important requirements | Relevant and valid measure |
| 3 | Effective implementation across important areas/issues, aligned with standard and context, with demonstrated operational effect | Get use of measures |
| 4 | Continuous improvement and integration | Good results: better than a comparable average or continuously improving trend |
| 5 | Role model, good practice, knowledge capture, innovation, and impact | Very good results: top quartile |

Do not use a future plan to justify the current score. Record what is done well, opportunities for improvement, development plan, confidence, and the smallest verification set needed. Keep organized evidence for survey verification.

## Cross-version navigation

The official edition 6-to-5 code crosswalk begins on book page 253 / PDF page 263. Use it when reusing an older SAR or evidence package. Do not assume identical intent merely because the code is unchanged; read the edition 6 overall requirement and new or expanded subtopics before migrating text.
